...
document.addEventListener('DOMContentLoaded', function () {
    new Typed('.home_title #subtitle', {
        strings: ['Officially known as Jitendra Singh Chauhan.', 'I am a crazy, creative and conceptualized Frontend Developer.', 'I like to do Frontend Designing, Prototyping and Development.', 'I deliver compact, reusable and quality code.'],
        typeSpeed: 50,
        backSpeed: 20,
        smartBackspace: true,
        loop: true
    ...
    $('.popup-link').magnificPopup({
        ...
        image: {
            titleSrc: function (item) {
                return item.el.attr('title') + '<small>by Jitu</small>';
            }
        }
    });
